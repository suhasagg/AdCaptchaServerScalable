Applications of Captchas (Adserver Supporting User input, (basic user interaction tracking also supported - impression + click tracking) , highly scalable cache based) with a purpose.
